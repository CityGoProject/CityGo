...
public class Bilet {
    ...
    public Bilet(Long id, Yolcu yolcu, Sefer sefer, Koltuk koltuk, double odenenTutar, BiletDurumu durum,
    ...
    @PrePersist // veritabanına yeni bilet kaydı eklenmeden hemen önce bu metod tetiklenir ve
                // biletin satın alınma anını sistem saatiyle kaydeder.
